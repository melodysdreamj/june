...
///No need to pass any context to June, just put the name of the route inside
///the parentheses and the magic will occur.
class _JuneImpl extends JuneInterface {}

// ignore: non_constant_identifier_names
final June = _JuneImpl();
