...
///
/// ```dart
/// class SomeController with JuneLifeCycle {
///   SomeController() {
///     configureLifeCycle();
///   }
/// }
/// ```
mixin JuneLifeCycleMixin {
  /// Called immediately after the widget is allocated in memory.
  /// You might use this to initialize something for the controller.
  @protected
  @mustCallSuper
  void onInit() {
    obscure(Engine.instance)?.addPostFrameCallback((_) => onReady());
  }
...
/// it is June.reset().
abstract class JuneService with JuneLifeCycleMixin, JuneServiceMixin {}
